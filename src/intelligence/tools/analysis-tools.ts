 ...
 * Tools focused on reading and analyzing contract code and safety
 */
...
export async function setupAnalysisTools(ai: AIClient, network: 'mainnet' | 'testnet' = 'mainnet') {
  ...
  log.info(`Registered ${ai.getRegisteredTools().length} analysis tools`);
  return ai;
}
